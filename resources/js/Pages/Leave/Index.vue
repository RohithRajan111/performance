...
// Compute calendar events filtered for current user only
...
// --- Upload Document Modal State and Methods (post-submission) ---
    ...
    <div class="p-6 bg-gray-50 min-h-screen">
      ...
      <div class="mb-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          <div v-for="leave in [{name: 'Casual Leave', color: 'text-blue-500', available: 5, consumed: 7, annual: 12, progress: 58}, {name: 'Sick Leave', color: 'text-red-500', available: 5, consumed: 2, annual: 6, progress: 33}, {name: 'Compensatory Leave', color: 'text-green-500', available: 5, consumed: 5, annual: 10, progress: 50}, {name: 'Special Holiday', color: 'text-purple-500', available: 5, consumed: 5, annual: 10, progress: 50}, {name: 'Loss of Pay', color: 'text-gray-400', available: 5, consumed: 5, annual: 10, progress: 50}]" :key="leave.name" class="bg-white p-4 rounded-lg shadow-sm text-center">
      ...
      <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
        <div class="xl:col-span-2 bg-white p-6 rounded-lg shadow-sm">
          <div class="flex justify-between items-center mb-4">
            ...
            <!-- Optionally add search or filters here -->
          </div>
              ...
              <tbody class="divide-y divide-gray-200">
                <tr v-for="request in props.leaveRequests" :key="request.id" class="text-gray-700 hover:bg-gray-50">
                  <td class="py-3 px-3">
                    ...
                    <p class="text-xs text-gray-500">{{ request.day_type === 'half' ? 'Half Day' : 'Full Day' }}</p>
                  </td>
                  <td class="py-3 px-3">
